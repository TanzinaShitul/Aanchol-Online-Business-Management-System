    ...
    <footer class="bg-dark text-white py-4 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h4>আঞ্চল-Aanchol</h4>
                    <p>Handmade fashion items crafted with love and tradition. Bringing Bangladeshi craftsmanship to your doorstep.</p>
                </div>
                <div class="col-md-4">
                    <h5>Quick Links</h5>
                    <ul class="list-unstyled">
                        ...
                        <li><a href="order-history.php" class="text-white text-decoration-none">My Orders</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <h5>Contact Us</h5>
