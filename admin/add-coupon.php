...
<head>
    ...
    <title>Add Coupon - Aanchol</title>
                        ...
                        <form method="POST">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control text-uppercase" id="code" name="code"
                                           placeholder="e.g. EID2026" value="<?= htmlspecialchars($_POST['code'] ?? '') ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" class="form-control" id="min_order_amount" name="min_order_amount" value="0">
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" class="form-control" id="max_discount_amount" name="max_discount_amount" placeholder="No cap">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" min="1" class="form-control" id="usage_limit" name="usage_limit" placeholder="Unlimited">
                                </div>
                                <div class="col-md-4 mb-3">
                            ...
                            <div class="alert alert-info small">
                                <i class="fas fa-info-circle"></i> Each customer can redeem a given coupon only once.
                            </div>
